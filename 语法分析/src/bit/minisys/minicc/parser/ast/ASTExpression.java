...
@JsonSubTypes({
	...
	@JsonSubTypes.Type(value = ASTAssignmentExpression.class,name = "AssignmentExpression"),
	@JsonSubTypes.Type(value = ASTRelationalExpression.class,name = "RelationalExpression"),
